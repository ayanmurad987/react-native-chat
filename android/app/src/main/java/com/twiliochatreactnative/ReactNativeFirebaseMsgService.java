package com.twiliochatreactnative;
...
import com.twiliochatreactnative.TwilioFCMNotificationPayload;
...
public class ReactNativeFirebaseMsgService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Intent i = new Intent("com.twiliochatreactnative.onFcmMessage");
        i.putExtras(bundle);
...
//        getApplicationContext().startService(service);
    ...
    private void displayPushInNotififcationArea(TwilioFCMNotificationPayload notificationPayload) {
        ...
        String channelId = "TwilioChatReactNative_default_channel_id";
        String channelDescription = "TwilioChatReactNative Default Channel";
        ...
        notificationManager.notify(0, new NotificationCompat.Builder(this)
                ...
                .setContentTitle("TwilioChatReactNative")
